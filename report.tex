...
\begin{figure}
    ...
    \caption{Droplet growth rate as the ambient temperature ($T$) is increased and the temperature-independent parameters are held constant.}
...
\begin{figure}
    ...
    \caption{Droplet growth rate as the supersaturation ($S - 1$) is increased, while the other model parameters stay constant.}
