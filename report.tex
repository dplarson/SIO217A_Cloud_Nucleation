...
applying diffusion equations to the droplet, shown in
...
Table~\ref{tab:MainResults} can be approximated. Yet, the approximation fails
...
Table~\ref{tab:MainResults}, it has its drawbacks with respect to reality. The
